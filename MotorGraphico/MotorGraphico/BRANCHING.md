...
`CMakeLists.txt` detecta automáticamente `third_party/glad` y `third_party/stb`: en cuanto existan, activa el target `motor_core` (Texture/Shader/Window) sin tocar nada más.
